  ...
  return (
    <button
      className={clsx(
        ...
        type === 'primary'
          ? 'bg-teal-500 hover:bg-teal-600 disabled:bg-teal-400 disabled:text-neutral-100 dark:bg-emerald-600 dark:hover:bg-emerald-500 dark:disabled:bg-neutral-700 dark:disabled:text-zinc-500'
