  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={clsx(
            'md:w-80 max-h-0 overflow-hidden bg-neutral-50 mr-0 ml-auto transition-all duration-200 mt-16 rounded-3xl absolute z-20 top-0 right-0 shadow-lg dark:bg-neutral-750 dark:shadow-neutral-700',
            isUserOpen && 'max-h-80'
          )}
        >
